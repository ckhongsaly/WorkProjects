//Main program for find and replace items
//To build program type: grade build
//To run program type: gradle run
//Changes can be made to main to change link
...
public class Main {
	...
	public static void main(String[] args) throws IOException{
		...
		System.out.println();
		System.out.println("Finding Link " + PORT_REMOVAL + "; At Directory: " + DIRECTORY);
		for (int i = 0; i < 3; i++) {
			System.out.print("--------------------------------------");
		}
		System.out.println();
